...
#define DADOS_LCD    	portBusStatus  	//4 bits de dados do LCD no PORTD 
...
#define E    			PD7     //pino de habilitação do LCD (enable)
#define RS   			PD6     //pino para informar se o dado é uma instrução ou caractere
